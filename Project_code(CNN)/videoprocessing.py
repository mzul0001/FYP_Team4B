...
def VideoProcessing(videoname):
    ...
    while video.isOpened():
        ...
        for emotion in labels:
            file.write(str(minute)+'minute '+str(second)+"second "+ str(FaceNo) +' ' + str(emotion) +'\n')
            FaceNo +=1
...
if __name__ == '__main__':
    ...
    VideoProcessing('') ##detect face,save the image and return the total number of detected face
##    x_test,y_test = []
